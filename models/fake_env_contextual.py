...
class FakeEnv:
    ...
    def __init__(self, model_dict, termination_fn, joint_state_reward_model=True):
    ...
    def step(self, obs, act, context):
        ...
        inputs_with_context = append_context_to_array(inputs, context)
        model_means, model_vars = self.get_prediction(inputs_with_context, factored=True)
